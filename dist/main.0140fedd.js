...
var hashMap = xObject || [];
var last = document.querySelector(".siteList li.last");
...
var render = function render() {
  document.querySelectorAll(".siteList li.newSite").forEach(function (node) {
    return node.remove();
  });
...
render();
document.querySelectorAll(".siteList a").forEach(function (node) {
  return node.addEventListener("click", removeSite);
});
...
//# sourceMappingURL=main.0140fedd.js.map